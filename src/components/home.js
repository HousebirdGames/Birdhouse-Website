export default async function Home() {
    ...
    <span class="mainHeading"><h3>Welcome to the</h3><h1>Birdhouse Framework</h1></span>
    </div>
    <div class="centerContent">
        ...
        <button id="installButton" class=""><span class="material-icons md-light spaceRight">download</span>Install the documentation for offline use</button> 
