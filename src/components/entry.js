...
export default async function Entry(route) {
    ...
    <div class="pageRow">
        ...
        ${route.originalPath != "Birdhouse/Hooks" ? '<a href="hooks" class="menuButton noBreak hideOnSmall"><span class="material-icons spaceRight">phishing</span>View all Hooks</a>' : ''}
        ${await Structure()}
        </div>
        <div class="pageColumn entry">
            <div class="buttonWrap start">
                ...
                ${route.originalPath != "Birdhouse/Hooks" ? '<a href="hooks" class="menuButton noBreak hideOnLarge"><span class="material-icons spaceRight">phishing</span>View all Hooks</a>' : ''}
